...
// Entre interfaces solo se puede hacer una herencia
...
class ContratoUltraCredit implements IContrato{
    ...
    suspender(cantidad: number): void {
        console.log(`Estas suspendido por: ${cantidad} días`);
        console.log('Información del contrato');

        // ??: Nullish coalescing operator - Valida que la expresion de la izquierda sea diferente de 
        // null o undefined. Si es null o undefined devolverá la expresión de la derecha, 
        ...
        console.log(`Tu salario es: ${this.salario ? this.salario : 1000}`); // <--- if ternario
    }
